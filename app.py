...
app = Flask(__name__, static_folder='./digit-recognizer/build', static_url_path='/')
CORS(app)
...
with open('./backend/weights/finetuned_weights.pkl', 'rb') as f:
...
def make_prediction(X):
    ...
    Z1 = W1 @ X + b1
    A1 = np.maximum(Z1, 0) #relu activatio
    Z2 = W2 @ A1 + b2
